...
const VideoComponent = ({
  ...
  const handleShowReplay = useCallback(() => {
    ...
    if (recordedChunks.length) {
      ...
      console.log("To be gen - ", ToBeGenBlob);
    ...
    <div className="md:w-1/2 mb-24 md:mb-0">
      ...
      <div className="flex justify-center mt-4">
        <button
          ...
          className={`shadow-custom-stuff flex gap-2 items-center justify-center px-3 py-1.5 rounded-md font-semibold text-lg bg-[#314aca] text-white active:bg-[#d2d2d2] active:text-black md:hover:text-black  md:hover:bg-[#d2d2d2] transition-all duration-300 w-[109px] h-[40px] disabled:bg-[#d2d2d2]`}>
          {isUploading ? (
