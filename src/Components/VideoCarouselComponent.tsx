...
const VideoCarouselComponent = ({
    ...
    const handleGoToNext = () => {
        if (currentVideoPosition < videos.length - 1) {
            ...
            setCurrentVideoPosition((prev: number) => prev + 1);
        }
    };
    ...
    return (
        <div className={` portrait:w-full w-1/2 ${loadingNextPage && "mr-4"}`}>
            ...
            <p className="text-[#959595] mb-8">
                View the videos below to watch the featured sign language content that need verification.
            </p>
            {loadingNextPage ? (
                <Swiper
                    ref={textSliderRef}
                ...
                <div className=" aspect-video">
                    <Swiper
                        ...
                        {videos?.length === 0 && error === "" ? (
                            <SwiperSlide className="  flex justify-center items-center h-full w-full rounded-md ">
                            ...
                            videos.map((video, id) => (
                                <SwiperSlide
                                    ...
                                    <div className="flex justify-center items-center h-full w-full relative videoDialog">
                                        <video src={video?.video_url} className="w-full h-full bg-black" playsInline controls></video>
            ...
            <div className="mt-7 w-full flex justify-between gap-4 items-center">
                ...
                <button
                    disabled={
                        currentVideoPosition === videos.length - 1 ||
                        loadingNextPage ||
                        videos?.length === 0
                    }
