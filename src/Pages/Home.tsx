      ...
      <div className="w-[90%] mx-auto flex flex-col md:flex-row-reverse ">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center lg:pr-4 relative pb-32 md:pb-0">
          ...
          <p className="md:text-lg mb-6 relative z-10">
            We strive to close the communication divide and ensure equal access
            to educational content for the Deaf and Hard of Hearing community.
            Your participation in this project has a meaningful impact on
            enhancing educational accessibility. Contribute to our cause, making
            education inclusive for all, as we work together towards a more
            accessible world—one sign at a time!
          </p>
          <Link
            to="/translate-text"
            ...
            Contribute{" "}
            <FaPlay className="text-sm group-hover:text-[#fa898e] " />
          </Link>
