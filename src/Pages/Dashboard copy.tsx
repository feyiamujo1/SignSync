  ...
  return (
    <div className=" m-0 flex min-h-screen w-full bg-[#f9fafb] p-0">
      <nav className="fixed inset-x-0 top-0 z-50 w-full bg-white py-4 shadow-md">
        <div className="mx-auto flex w-[97%] justify-between">
      ...
      <div className="relative flex w-full">
        ...
        <main className="w-full bg-white px-2 pb-10 shadow-md md:ml-[365px] md:px-6 ">
          {/* <div className="py-4"> */}
          <div className="w-[90%] mx-auto pb-20 md:w-full bg-white md:mt-[100px]">
            <Routes>
              <Route path="/" element={<DashboardHome />} />
              <Route
                path="/admin/view-all-text"
