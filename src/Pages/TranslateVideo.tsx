...
import VideoTranslateTextComponent from "../Components/VideoTranslateTextComponent";
    ...
    const fetchVideos = async () => {
        ...
        try {
            const response = await axios.get(
                `https://sign-language-gc07.onrender.com/api/main/videos/${role}?page=${page}`,
                {
                    headers: {
                        Authorization: `${token}`,
                    ...
                    <div className="w-[90%] mx-auto pt-24 pb-20">
                        <div className="w-full flex flex-row portrait:flex-col  gap-10">
                            <VideoCarouselComponent
                                ...
                                setCurrentVideoPosition={setCurrentVideoPosition}
